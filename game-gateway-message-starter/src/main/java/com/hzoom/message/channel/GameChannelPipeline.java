...
public class GameChannelPipeline {
    ...
    public final GameChannelPipeline fireChannelReadRPCRequest(IMessage gameMessage) {
    ...
    public final GameChannelFuture writeAndFlush(IMessage msg, GameChannelPromise promise) {
        return tail.writeAndFlush(msg, promise);
    }

    public final GameChannelFuture writeAndFlush(IMessage msg) {
        return tail.writeAndFlush(msg);
    }

    public final void writeRpcRequest(IMessage gameMessage, Promise<IMessage> promise) {
    ...
    final class HeadContext extends AbstractGameChannelHandlerContext implements GameChannelOutboundHandler, GameChannelInboundHandler {
        ...
        @Override
        public void writeAndFlush(AbstractGameChannelHandlerContext ctx, IMessage gameMessage, GameChannelPromise promise) throws Exception {
            MessagePackage gameMessagePackage =new MessagePackage();
            IMessage.Header header = gameMessage.getHeader().clone();
            //重新设置playerId，防止不同channel之间由于使用同一个IMessage实例，相互覆盖
        ...
        @Override
        public void writeRPCMessage(AbstractGameChannelHandlerContext ctx, IMessage gameMessage, Promise<IMessage> callback) {
