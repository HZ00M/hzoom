...
import com.example.core.netty.web.filter.BadRequestFilter;
...
@Slf4j
@ServerEndpoint(beforeHandShakeFilters = {BadRequestFilter.class},host = "${netty-websocket.host}", path = "${netty-websocket.path2}", port = "${netty-websocket.port2}",bossLoopGroupThreads = "1",workerLoopGroupThreads = "10")
@Component
public class MyWebSocket2 {
    ...
    public void OnMessage(Session session, String message, @RequestParam Long connectTime, @PathVariable("{0}") String path) {
